    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Contact Form */}
          <Card className="border-none shadow bg-surprise-purple/20 hover:bg-surprise-purple/20">
          ...
          {/* Contact Info */}
          <div className="space-y-2">
            <Card className="border-none shadow bg-blue-100 hover:bg-blue-200">
            ...
            <Card className="border-none shadow bg-green-100 hover:bg-green-200">
              <CardContent className="p-4">
                <div className="flex items-start gap-4">
            ...
            <Card className="border-none shadow bg-teal-100 hover:bg-teal-200">
              <CardContent className="p-4">
                <div className="flex items-start gap-4">
            ...
            <Card className="border-none shadow bg-surprise-coral/10 hover:bg-surprise-coral/20">
              <CardContent className="p-4">
                <div className="flex items-start gap-4">
